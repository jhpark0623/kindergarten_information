  ...
  return (
    <Layout>
      <div className="flex justify-center w-[700px] pt-10">
        <div className="w-[200px] flex items-center flex-col border-r-2 p-4 ">
          지역 선택
          <select
            name="selectSiDo"
          ...
          <button
            onClick={search}
            className="border-2  bg-blue-400 w-full h-10"
          >
            검색
          </button>
        </div>
        {searchData.length ? (
          ...
          <div className="w-full flex justify-center my-10 text-2xl">
            지역을 선택해주세요
          </div>
        )}
      </div>
